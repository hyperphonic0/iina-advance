...
on. This tool rewrites their internal references from Nix paths to the libs within the app bundle and/or system libs,
and uses a consistent naming scheme to facilitate interoperability with the Xcode project, which enables ongoing code
...
It also replaces Nix's hard-coded paths to /nix/store/ with relative paths within the app bundle, which is necessary to
package the app for distribution.

Arg `--canonicalize` (pseudocode outline):
------------------------------------------
