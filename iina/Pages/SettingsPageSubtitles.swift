...
fileprivate class SubtitlesEncodingView: SettingsAccessory.Base {
  ...
  @objc func changeDefaultEncoding(_ sender: NSPopUpButton) {
    ...
    guard let activePlayer = PlayerManager.shared.activePlayer else { return }
    activePlayer.setSubEncoding((sender.selectedItem?.representedObject as? String) ?? "auto")
    activePlayer.reloadAllSubs()
  }
}
